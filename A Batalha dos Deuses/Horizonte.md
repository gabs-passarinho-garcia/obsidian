...
graph TD
    ...
    classDef reino fill:#561818,stroke:#d4af37,stroke-width:2px,color:#fff;
    classDef exilio fill:#0d2b45,stroke:#5c80bc,stroke-width:2px,color:#fff;
    ...
    subgraph Era da Formação [Sangue e Fogo]
        V1 --> V2(Vol II: A Praga do Nilo)
        V2 --> V3(Vol III: A Coroa de Cinzas)
        V3 --> V4(Vol IV: O Fogo do Carmelo)
    end

    subgraph Era dos Reis e Impérios [A Máquina de Guerra]
        V4 --> V5(Vol V: O Cerco de Jerusalém)
        V5 --> V6(Vol VI: A Boca da Besta)
    end

    subgraph A Batalha Final [A Morte da Morte]
        V6 --> V7(Vol VII: O Sangue do Cordeiro)
        V7 --> V8(Vol VIII: O Trono Branco)
    end

    %% Classes
    class V0,V1 primordial;
    class V2,V3,V4 reino;
    class V5,V6 exilio;
    class V7,V8 final;
...
### 👑 Vol III: A Coroa de Cinzas (Saul & Endor)
...
### 🔥 Vol IV: O Fogo do Carmelo (Elias)
* **Base:** 1 Reis 18.
...
### ⚔️ Vol V: O Cerco de Jerusalém (Senaqueribe)
* **Status:** 🚧 **EM PRODUÇÃO**
* **Base:** 2 Reis 18-19.
...
* **Link:** [[A Batalha dos Deuses/A Batalha dos Deuses|Vol V: O Cerco]]

### 🦁 Vol VI: A Boca da Besta (Daniel)
* **Base:** Daniel 3 e 6.
...
### ✝️ Vol VII: O Sangue do Cordeiro (Paixão)
* **Base:** Evangelhos.
...
### ⚖️ Vol VIII: O Trono Branco (Apocalipse)
* **Base:** Apocalipse.
* **O Inimigo:** O **Dragão**.
