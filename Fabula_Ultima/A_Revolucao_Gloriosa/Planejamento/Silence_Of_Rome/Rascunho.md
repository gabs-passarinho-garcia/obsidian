...
graph TD
    ...
    JEN((Jennifer / Governanta))
    IS((Isabella Stuart))

    J2 -- Anfitrião / Chantageava --> PI
    JEN -- Ferida Antiga / Matou com Alga --> PI
    JEN -- Finge Ajudar / Destrói Provas --> G
    JEN -- Incriminou / Planta Alga em --> PJ
    JEN -- Roubou Alga Tropical de --> MN
    JEN -- Tenta Culpar Criados --> IRL[Irlandeses / Bode Expiatório]
    MSG -- Impõe Prisão a --> PJ
    MN -- Importou Alga Tropical da Guiana --> Crime[Ala dos Hóspedes]
    LD -- Conspira com Holandeses contra --> J2
    IS -.Manipulou com Mentiras / Segredo do Mestre.-> JEN
    G -- Busca 9 Pistas para Inocentar --> PJ
```
